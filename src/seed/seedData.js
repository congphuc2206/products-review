 ...
 * 
 * Minh họa cấu trúc Document linh hoạt (Flexible Schema) của MongoDB:
 * Mỗi sản phẩm có các trường hoàn toàn khác nhau bên trong `specifications`
 * và mỗi đánh giá chứa các mảng linh hoạt cho `pros`, `cons`, `tags`, `images`.
 */
